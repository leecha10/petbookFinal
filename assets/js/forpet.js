...
bootDemo.controller('ModalInstanceCtrl', function ($scope, $uibModalInstance, items) {
...
//Carousel Ctrl
bootDemo.controller('CarouselDemoCtrl', function ($scope) {
...
//Firebase
// facebook 로그인 유지
bootDemo.factory('$localstorage', ['$window', function($window) {
  return {
